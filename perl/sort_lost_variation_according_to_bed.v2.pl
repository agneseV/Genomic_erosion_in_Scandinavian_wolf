#!usr/bin/perl
#This is individually tailored script to count the number of concordant SNPs between the lost 1 Mb haplotype clusters (bed file) and lost individual founder alleles in 1994-2005.
...
#Positions of concordant SNPs are printed to a separate file for each founder (ends with .concordantSNPs) and number of SNPs per each 1 Mb haplotype cluster are printed in output file
#Usage: perl sort_lost_variation_according_to_bed.pl input.intervals.BED output
...
my $infile_FF = "D-85-01.alleles.not.in.1994-2005";
my $outfile_FF = "D-85-01.alleles.not.in.1994-2005.concordantSNPs";
my $infile_FM1 = "FM1-offsp.alleles.not.in.1994-2005";
my $outfile_FM1 = "FM1-offsp.alleles.not.in.1994-2005.concordantSNPs";
my $infile_FM2 = "FM2-offsp.alleles.not.in.1994-2005";
my $outfile_FM2 = "FM2-offsp.alleles.not.in.1994-2005.concordantSNPs";
